...
def train_nontext_data(features, labels):
    ...
    print("Saving Model...")
    pickle.dump(model, open('../SavedModels/logistic_fraud.sav', 'wb'))
...
def train(df, train_data):
    ...
    pickle.dump(model, open('../SavedModels/logistic_reg_tfidf.sav', 'wb'))
    pickle.dump(vectorizer, open('../SavedModels/logistic_reg_tfidf_vec.sav', 'wb'))
